...
const (
	...
	Rule_TYPE_ADMISSION Rule_Type = 1
)
...
type Rule struct {
	...
	// type indicates what type of enforcement rule is used for (runtime or admission)
...
const file_rule_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"rule.proto\x12\x04rule\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xbc\x06\n" +
	"\x04Rule\x12\x0e\n" +
	...
	"\bbinaries\x18\x04 \x03(\tR\bbinariesJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03\",\n" +
	"\x04Type\x12\x10\n" +
	"\fTYPE_RUNTIME\x10\x00\x12\x12\n" +
	"\x0eTYPE_ADMISSION\x10\x01J\x04\b\x04\x10\x05\" \n" +
