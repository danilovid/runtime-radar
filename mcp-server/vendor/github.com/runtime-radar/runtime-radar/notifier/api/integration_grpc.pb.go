...
func (c *integrationControllerClient) TestAI(ctx context.Context, in *TestAIReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, IntegrationController_TestAI_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *integrationControllerClient) ExplainRuntimeEvent(ctx context.Context, in *ExplainRuntimeEventReq, opts ...grpc.CallOption) (*ExplainRuntimeEventResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExplainRuntimeEventResp)
	err := c.cc.Invoke(ctx, IntegrationController_ExplainRuntimeEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIntegrationControllerServer) TestAI(context.Context, *TestAIReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestAI not implemented")
}
...
func _IntegrationController_TestAI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestAIReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntegrationControllerServer).TestAI(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IntegrationController_TestAI_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntegrationControllerServer).TestAI(ctx, req.(*TestAIReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _IntegrationController_ExplainRuntimeEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExplainRuntimeEventReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntegrationControllerServer).ExplainRuntimeEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IntegrationController_ExplainRuntimeEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntegrationControllerServer).ExplainRuntimeEvent(ctx, req.(*ExplainRuntimeEventReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IntegrationController_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TestAI",
			Handler:    _IntegrationController_TestAI_Handler,
		},
		{
