...
const (
	Notifier_Notify_FullMethodName = "/notifier.Notifier/Notify"
)
...
func (c *notifierClient) Notify(ctx context.Context, in *NotifyReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedNotifierServer) Notify(context.Context, *NotifyReq) (*emptypb.Empty, error) {
...
func _Notifier_Notify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotifierServer).Notify(ctx, req.(*NotifyReq))
	}
