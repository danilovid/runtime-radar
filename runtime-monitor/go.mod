...
require (
	...
	github.com/cilium/cilium v1.17.0-pre.3 // indirect
	github.com/cilium/tetragon/pkg/k8s v0.0.0-20240515145252-be19aebaccbf // indirect
...
replace github.com/runtime-radar/runtime-radar/lib => ../lib
